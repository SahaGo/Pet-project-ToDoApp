...
В 5 уроке  подтянуто чтение конфигов из пакета config, сокрытие пароля с помощью godoenv в .env

В 6 уроке  связь между структурами приложения, бизнес лгийкой и тд, sha1  хэширование паролей пользователя, константа salt для хэширования, 